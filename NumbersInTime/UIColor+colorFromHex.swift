    ...
    class func colorFromHex(hexString:String) -> UIColor {
        ...
        func clean(hexString: String) -> String {
            ...
            if(hexString[hexString.startIndex] == "#") {
                let myIndex = hexString.index(hexString.startIndex, offsetBy: 1)
                cleanedHexString = String(hexString[myIndex...])
                //hexString.substring(from: hexString.characters.index(hexString.startIndex, offsetBy: 1))
            }
